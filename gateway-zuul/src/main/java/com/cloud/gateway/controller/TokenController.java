...
import com.zero.api.model.oauth.SystemClientInfo;
...
public class TokenController {
    ...
    public Map<String, Object> login(@RequestBody LoginAppUser loginAppUser) {
...
//		parameters.put("username", username);
        ...
        parameters.put("username", loginAppUser.getUsername() + "|" + CredentialType.USERNAME.name());
        parameters.put("password", loginAppUser.getPassword());

        Map<String, Object> tokenInfo = oauth2Client.postAccessToken(parameters);
        saveLoginLog(loginAppUser.getUsername(), "用户名密码登陆");
