...
import com.zero.api.model.user.WechatUserInfo;
import com.zero.user.server.feign.GatewayClient;
...
public class WechatController {
    ...
    public RedirectView toWechatAuthorize(@PathVariable String app, HttpServletRequest request,
                                          @RequestParam(required = false) String toUrl) throws UnsupportedEncodingException {
    ...
    public Map<String, Object> wechatBack(HttpServletRequest request, @PathVariable String app, String code, String state,
        ...
        //通过gateway调用登录接口
        String tempCode = wechatService.cacheWechatUserInfo(wechatUserInfo);
        return gatewayClient.loginByWechat(wechatUserInfo.getOpenid(), tempCode);
    }
